...
public class Timeline_Packet_Exposi extends Packet_Exposimeter{
    ...
    Timeline_Packet_Exposi(byte[] packet_in){
        packet = packet_in;
    }
    ...
    public int get_attenuator(){
        return (int) get_attenuatorB() & 0xFF;
    }
    ...
    public byte[] get_reservedGPS(){return split_packet(49, 87);}
